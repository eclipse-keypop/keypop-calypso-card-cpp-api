...
public:
     ...
     * @return a not empty copy of the record subset content when the record is
     * set, an empty array when the record is not set.
     ...
     * [(numCounter - 1) * 3] of the record #1.<br> e.g. if numCounter == 2,
     * then value is extracted from bytes indexes [3,4,5].
     *
