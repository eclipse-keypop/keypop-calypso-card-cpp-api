...
public:
     ...
     * Virtual destructor.
     */
    virtual ~SearchCommandData() = default;
     ...
     * @since 1.1.0
     */
    virtual SearchCommandData& setSfi(std::uint8_t sfi) = 0;
     ...
     * @since 1.1.0
     */
    virtual SearchCommandData& startAtRecord(int recordNumber) = 0;
     ...
     * @since 1.1.0
     */
    virtual SearchCommandData& setOffset(int offset) = 0;
     ...
     * @since 1.1.0
     */
    virtual SearchCommandData&
    setSearchData(const std::vector<std::uint8_t>& data) = 0;

    /**
     * Sets the mask of bits to take into account during the comparison (padded
     * right with FFh if absent or incomplete).
     *
     * <p>Requirement: The length of the mask must be <b>less or equal</b> than
     ...
     * @since 1.1.0
     */
    virtual SearchCommandData& setMask(const std::vector<std::uint8_t>& mask)
        = 0;
