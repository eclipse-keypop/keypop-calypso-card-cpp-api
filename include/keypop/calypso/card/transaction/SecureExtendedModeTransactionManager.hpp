 ...
 */
template <typename T>
class SecureExtendedModeTransactionManager : public SecureSymmetricCryptoTransactionManager<T> {
public:
    /**
     ...
     * therefore be used only for the case mentioned above. As a reminder, closing the secure
     * session also performs a mutual authentication of the card and the terminal.
     *
     * <p>When it is needed, it is advised to use this command only once at the beginning of the
     * secure session.
     *
     * @return The current instance.
     * @throw UnsupportedOperationException The "Manage Secure Session" command is not available for
