...
class SecureExtendedModeTransactionManagerBase
: public virtual SecureTransactionManager<
      SecureExtendedModeTransactionManagerBase> {
public:
    /**
     * virtual destructor.
     */
    virtual ~SecureExtendedModeTransactionManagerBase() = default;
     ...
     * is not available for this context (Card and/or CRYPTOGRAPHIC MODULE does
     * not support the extended mode).
